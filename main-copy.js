          ...
          return (
            ...
            !e.lastPlayedTs || Na(new Date(e.lastPlayedTs), e.today) >= 1
              ? ((e.boardState = new Array(6).fill("")),
                ...
                (e.solution = is_today_special() ? 'yesss' : Da(e.today)),
          ...
          o(t, [
            {
              ...
              value: function (is_special) {
                if (
                  is_special ||
                  (5 === this.tileIndex && !(this.rowIndex >= 6))
                ) {
                  var e,
                  ...
                  if (
                    !is_special &&
                    ((e = s), !Ta.includes(e) && !La.includes(e))
                  )
                    return (
                      a.setAttribute("invalid", ""),
                      void this.addToast("Not in word list")
                    );
                  if (!is_special && this.hardMode) {
            ...
            },
            {
              key: "submitGuess",
              value: function () {
                var is_special = is_today_special();
              ...
              value: function () {
                ...
                this.$game.addEventListener("game-key-press", function (a) {
                  ...
                  "←" === s || "Backspace" === s
                    ...
                    : "↵" === s || "Enter" === s
                    ? e.submitGuess()
                    : (Ba.includes(s.toLowerCase()) || a.detail.is_special) &&
                      ...
                      (a.path || (a.composedPath && a.composedPath())).includes(
                        ...
                        ([es, as].includes(e.gameStatus) &&
                          (e.restoringFromLocalStorage
                            ...
                            : (e.gameStatus === es &&
                                (s.setAttribute("win", ""),
                                e.addToast(is_today_special() ? 'WHEEEEEEEEEEEEEE 💍💑' : ss[e.rowIndex - 1], is_today_special() ? 20e3 : 2e3)),
                              e.gameStatus === as &&
